            ...
            <div class="about type-1 padbot_120">
                <div class="container">
                    ...
                    <div class="col-md-4 col-sm-12 about-image top_30 wow fadeInUp"  data-wow-delay="0.4s">
                        <div class="row">
                            <img src="{{ asset('fontend/images/profile-2.jpg')}}" alt="">
                        </div>
                    </div>
                    <!-- about text -->
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="isotope_items row">
                            ...
                            <!-- Item -->
                            <a href="{{ asset('fontend/images/work-2.jpg')}}" class="single_item link aplication col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.6s">
                                <figure>
                            ...
                            <!-- Item -->
                            <a href="{{ asset('fontend/images/work-3.jpg')}}" class="single_item link development col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.9s">
                                <figure>
                            ...
                            <!-- Item -->
                            <a href="{{ asset('fontend/images/work-4.jpg')}}" class="single_item link web-design col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="1.2s">
                                <figure>
                                    <img src="{{ asset('fontend/images/work-4.jpg')}}" alt=""> 
                                    <figcaption>
                                        <div class="outter">
                                            <div class="inner">
                                                <span>Branding</span>
                            ...
                            <!-- Item -->
                            <a href="{{ asset('fontend/images/work-5.jpg')}}" class="single_item link aplication col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="1.5s">
                                <figure>
                                    <img src="{{ asset('fontend/images/work-5.jpg')}}" alt=""> 
                                    <figcaption>
                                        <div class="outter">
                                            <div class="inner">
                                                <span>Web Design</span>
                            ...
                            <!-- Item -->
                            <a href="{{ asset('fontend/images/work-6.jpg')}}" class="single_item link aplication col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="1.8s">
                                <figure>
                                    <img src="{{ asset('fontend/images/work-6.jpg')}}" alt=""> 
                                    <figcaption>
                                        <div class="outter">
                                            <div class="inner">
